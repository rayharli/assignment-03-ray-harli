...
const definitionName = 'script.gh'
...
async function compute() {
    ...
    const param1 = new RhinoCompute.Grasshopper.DataTree('L_EXTENT_X')
    param1.append([0], [L_EXTENT_X_slider.valueAsNumber])

    const param2 = new RhinoCompute.Grasshopper.DataTree('L_EXTENT_Y')
    param2.append([0], [L_EXTENT_Y_slider.valueAsNumber])
